        ...
        Self {
            so: {
                let soname = match (blade_type, blade_v1_1) {
                    (BladeType::None, _) => "wasm_obj/tea/ref.so",
                    (BladeType::Baseline, true) => "wasm_obj/tea/baseline_with_v1_1.so",
                    (BladeType::Baseline, false) => "wasm_obj/tea/baseline_no_v1_1.so",
                    (BladeType::Lfence, true) => "wasm_obj/tea/lfence_with_v1_1.so",
                    (BladeType::Lfence, false) => "wasm_obj/tea/lfence_no_v1_1.so",
                    (BladeType::LfencePerBlock, true) => "wasm_obj/tea/lfence_per_block_with_v1_1.so",
                    (BladeType::LfencePerBlock, false) => "wasm_obj/tea/lfence_per_block_no_v1_1.so",
                    (BladeType::SLH, true) => "wasm_obj/tea/slh_with_v1_1.so",
                    (BladeType::SLH, false) => "wasm_obj/tea/slh_no_v1_1.so",
                };
