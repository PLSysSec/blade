        ...
        Self {
            so: {
                let soname = match (blade_type, blade_v1_1) {
                    (BladeType::None, _) => "wasm_obj/sha256/ref.so",
                    (BladeType::Baseline, true) => "wasm_obj/sha256/baseline_with_v1_1.so",
                    (BladeType::Baseline, false) => "wasm_obj/sha256/baseline_no_v1_1.so",
                    (BladeType::Lfence, true) => "wasm_obj/sha256/lfence_with_v1_1.so",
                    (BladeType::Lfence, false) => "wasm_obj/sha256/lfence_no_v1_1.so",
                    (BladeType::LfencePerBlock, true) => "wasm_obj/sha256/lfence_per_block_with_v1_1.so",
                    (BladeType::LfencePerBlock, false) => "wasm_obj/sha256/lfence_per_block_no_v1_1.so",
                    (BladeType::SLH, true) => "wasm_obj/sha256/slh_with_v1_1.so",
                    (BladeType::SLH, false) => "wasm_obj/sha256/slh_no_v1_1.so",
                };
